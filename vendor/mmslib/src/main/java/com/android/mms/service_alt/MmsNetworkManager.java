...
public class MmsNetworkManager implements com.squareup.okhttp.internal.Network {
    ...
    private static final int NETWORK_REQUEST_TIMEOUT_MILLIS = 10 * 1000;
...
//            }
    ...
    public InetAddress[] resolveInetAddresses(String host) throws UnknownHostException {
        ...
        synchronized (this) {
            if (mNetwork == null) {
                // No MMS network acquired; fall back to the platform DNS so we can
                // still reach the MMSC over the default network.
